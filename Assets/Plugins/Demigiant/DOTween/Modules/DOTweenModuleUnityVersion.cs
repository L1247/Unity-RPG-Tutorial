...
namespace DG.Tweening
{
    ...
    #region Public Methods
        ...
        /// <summary>
        ///     Returns a <see cref="CustomYieldInstruction" /> that waits until the tween is killed or has gone through the given amount of
        ///     loops.
        ///     It can be used inside a coroutine as a yield.
        ///     <para>Example usage:</para>
    ...
    #region Material
        ...
        public static TweenerCore<Vector2 , Vector2 , VectorOptions> DOOffset(
                this Material target , Vector2 endValue , int propertyID , float duration)
        {
            ...
            var t = DOTween.To(() => target.GetTextureOffset(propertyID) , x => target.SetTextureOffset(propertyID , x) , endValue ,
                               duration);
            t.SetTarget(target);
            return t;
        }
                ...
                this Material target , Vector2 endValue , int propertyID , float duration)
        {
            ...
            var t = DOTween.To(() => target.GetTextureScale(propertyID) , x => target.SetTextureScale(propertyID , x) , endValue ,
                               duration);
            t.SetTarget(target);
            return t;
        }
    ...
    #region Async Instructions
        ...
        /// <summary>
        ///     Returns an async <see cref="System.Threading.Tasks.Task" /> that waits until the tween is killed or has gone through the given
        ///     amount of loops.
        ///     It can be used inside an async operation.
        ///     <para>Example usage:</para>
